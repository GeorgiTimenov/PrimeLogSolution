...
if (!class_exists('Contact')) {
    ...
    class Contact
    {
        ...
        private function __construct()
        {
            ...
            $this->_replyHtmlMailTemplate .= '<tr><td><p>We just received your quote request.<br />We\'ll reach you as soon as possible.</p><br /></td></tr>'; 
